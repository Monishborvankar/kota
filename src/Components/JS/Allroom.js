...
export default function Allroom() {
  ...
  return (
    <div style={{minHeight:"90vh"}} id="Service">
        ...
        <h1 data-aos="flip-left" style={{margin:"0px",textAlign:"center",padding:"10px",}}>Add Room</h1>
    ...
    <Card sx={{ maxWidth: 345,margin:'25px' }} color="white" data-aos="class" id="card">
      <CardHeader
      style={{color:"white", textAlign:"center"}}
        title="Add Room for Paying Guest"
